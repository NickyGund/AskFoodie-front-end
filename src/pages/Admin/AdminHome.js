...
export default (props) => {
    return (
        <View style = {{flex:1,}}>
            ...
            >
                <SlideNavigator.Screen name={'restaurantList'} options={{ headerShown:false, gestureEnabled: true }}>
                    {({ navigation }) => (
                    <RestaurantList
                ...
                <SlideNavigator.Screen name={'comments'} component = {Comments} options={{ gestureEnabled: true }}/>
